...
public class ProviderOrderAdapter extends RecyclerView.Adapter<ProviderOrderAdapter.MyViewHolder> {
    ArrayList<OrderModel> orderModels;
    Context context;
    public ProviderOrderAdapter(Context context, ArrayList<OrderModel> _postModels) {
